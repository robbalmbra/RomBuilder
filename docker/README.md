...
* ADDITIONAL_CHANGELOGS - Specifies additional entries to add to the changelog, seperated by a "|" character. e.g `added faceunlock; ported livedisplay from sources`
